...
from resources.order import order_make, order_user_filter, order_shop_filter, order_detail, order_user_cancel, order_shop_complete, order_shop_cancel
...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:////Users/yoona/Downloads/HW3_team30_test/UberEat-Booking-System/backend/database2.db'
...
api.add_resource( order_shop_complete, "/order/shop_complete")
api.add_resource( order_shop_cancel, "/order/shop_cancel")
