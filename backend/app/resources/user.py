...
#         # 2. check value
#         data = try_put_info.parser.parse_args()
#         latitude     = data['latitude']
#         longitude     = data['longitude']
...
#         # 3. pass the format than save change to db
#         UserModel.edit_location(identity, ast.literal_eval(latitude), ast.literal_eval(longitude))
